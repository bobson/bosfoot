import { type Locale, t, pickLocale, formatPrice, localePath } from '@/lib/i18n'
...
/**
 * React port of the Astro ProductCard. Used in the filtered listing where
 * cards are dynamically shown/hidden via React state.
 *
 * Visually identical to ProductCard.astro — same HTML structure, same Tailwind
 * classes. Just rendered through React so it can participate in the listing's
